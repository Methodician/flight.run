  ...
  public services = [
    {
      ...
      description: `
      We believe in powerful, smart, scalable apps and tools that help people work better and faster, improve conversion rates, 
    ...
    },
    {
      ...
      description: `
      We’re passionate about clean design and intuitive user experience. Lines, colors, and angles can tell stories, 
      display dense data, and keep users on your page longer.
      `,
    },
    {
      ...
      description: `
      It’s the little things that set you apart. Not every MVP has to be built with cookie-cutter elements. 
      Custom graphics and icons will captivate your audience, convey meaning, and direct attention.
      `,
    },
    {
      ...
      description: `
      Turning an idea to a business takes diligence and iteration. Scalability, monetization, technology, 
      timing, marketing, and more come into play. 
      No need to finalize your idea in a vacuum.
      `,
    },
    {
  ...
  public paths = [
    {
      ...
      description: `
      Rapid user adoption of a new product or service. Usually best suited for low-margin, mass-market ideas. 
    ...
    },
    {
      ...
      description: `
      More money is generated by the product than it consumes. Best suited for sales-heavy, high-margin 
      products or services. Helps make your idea presentation-ready.
      `,
    },
    {
      title: 'Presentation Ready',
      description: `
      Your product is compelling to investors and early adopters. Your pitch is legitimate, and you 
      have skin in the game. Ideally, you have some cash flow or lots of users.
      `,
    },
  ];
