export const questions = {
  ...
  fr: [
    ...
    "What do you think are your strongest points in web app development?",
  ...
  aip: [
    ...
    "Working with project management, and organizational tools (like asana, trello, calendar tools, meistertask, time trackers, etc…)",	"Working with GIT or other source control tools",																	
